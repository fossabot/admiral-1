...
const file_authn_v1_authn_proto_rawDesc = "" +
	"\n" +
	"\x14authn/v1/authn.proto\x12\x10admiral.authn.v1\x1a\x1cgoogle/api/annotations.proto\x1a\x1egoogle/protobuf/duration.proto\x1a\x1bbuf/validate/validate.proto\"1\n" +
	"\fLoginRequest\x12!\n" +
	...
	"\faccess_token\x18\x01 \x01(\tR\vaccessToken2\xd7\x02\n" +
	"\bAuthnAPI\x12]\n" +
	...
	"\bCallback\x12!.admiral.authn.v1.CallbackRequest\x1a\".admiral.authn.v1.CallbackResponse\"\x16\x82\xd3\xe4\x93\x02\x10\x12\x0e/auth/callback\x12\x80\x01\n" +
