...
export const environmentSchema = z.object({
  ...
  clusterId: z.string().uuid({ message: 'Cluster ID must be a valid UUID' }).optional(),
...
export const listEnvironmentsSchema = z.object({
  environments: environmentArraySchema,
  nextPageToken: z.string().optional(),
});

export type Environment = z.infer<typeof environmentSchema>;
export type EnvironmentList = z.infer<typeof environmentArraySchema>;
